      ...
      builder: (_, child) {
        return MultiBlocProvider(
          providers: [
            ...
            BlocProvider(create: (context) => LogOutCubit()), // Add ThemeCubit here
          ],
              ...
              return MaterialApp.router(
                theme: themeState == ThemeState.light
                    ? ThemeData.light().copyWith(
                        ...
                        appBarTheme: const AppBarTheme(backgroundColor: AppColors.kAppBar2Color),
                      )
                    : ThemeData.dark().copyWith(
                        ...
                        scaffoldBackgroundColor: DarkModeColors.kBackGroundDark),
